...
include("connexion.php");
//requette pour recuperer la liste des emails stockés sur la base de données

$sql=$bdd->query("SELECT * FROM email");
// affichage des resultats dans un tableau
echo '<table border="0">';
echo '<tr id="head"><td  width="250">E-mail</td><td  width="250">Options</td>';
while($resultat=$sql->fetch())
{
echo '<tr id="corp"><td>'.$resultat["email"].'</td><td> </td>';
}
echo '</table>';	
     ?>
