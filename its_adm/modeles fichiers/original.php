...
<body>
	...
	<div id="top-bar">
		...
		<div class="page-full-width cf">
			...
			<ul id="nav" class="fl">
				...
				<li class="v-sep"><a href="#" class="round button dark ic-left-arrow image-left">Vers le site</a></li>
				<li class="v-sep"><a href="#" class="round button dark menu-user image-left">Logged in as <strong>admin</strong></a>
					<ul>
						<li><a href="#">Mon profile</a></li>
						<li><a href="#">Parametres utilisateur</a></li>
						<li><a href="#">Parametres du mot de passe</a></li>
						<li><a href="modules/deconnexion.php">Deconnexion</a></li>
					</ul> 
				</li>
			
				<li><a href="#" class="round button dark menu-email-special image-left">Mes messages</a></li>
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				<li><a href="dashboard.html" class="active-tab dashboard-tab">Accueil</a></li>
				<li><a href="page-full-width.html">page 1</a></li>
				<li><a href="page-other.html">page 2</a></li>
			</ul> <!-- end tabs -->
