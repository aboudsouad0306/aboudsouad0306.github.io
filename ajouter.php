...
<div class="container">
 ...
 <td>
 <p id="warning"><font size="4">Vous devez être membre de FindDz pour que vous puissiez ajouter votre entreprise dans notre annuaire!!.</font></p></td>
 </tr>
 </table>

   <h1><a href="inscription.php"> Inscrivez-vous maintenait et Inscrivez votre entreprise </a> </h1>
    <!-- end .content -->
    </div>
